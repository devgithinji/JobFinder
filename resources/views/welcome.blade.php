...
<div class="site-wrap">
            ...
            <div class="row">
                <div class="col-md-12 mb-5 mb-md-0" data-aos="fade-up" data-aos-delay="100">
                                ...
                                <div class="job-details h-100">
                                    <div class="p-3 align-self-center">
                                        ...
                                        <div class="d-block d-lg-flex">
                                            ...
                                            <div class="mr-3"><span
                                                    class="icon-room mr-1"></span>{{str_limit($job->address,20)}}</div>
                                            <div><span class="icon-money mr-1"></span>${{$job->salary}} / yr</div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-12 text-center mt-5">
                        <a href="{{route('alljobs')}}" class="btn btn-primary rounded py-3 px-5"><span class="icon-plus-circle"></span>
                            Show More Jobs</a>
                    </div>
                </div>
            </div>
    ...
    <div class="site-blocks-cover overlay inner-page"
         style="background-image: url({{asset('external/images/hero_1.jpg')}});" data-aos="fade"
        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-md-6 text-center" data-aos="fade">
                    ...
                    <p>
                        <a href="{{route('register')}}" class="btn btn-outline-warning py-3 px-4">Job Seeker</a>
                        <a href="{{route('register')}}" class="btn btn-warning py-3 px-4">Employer</a>
                    </p>
                </div>
            </div>
        </div>
