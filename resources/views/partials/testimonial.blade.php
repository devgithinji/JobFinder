    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-5 ml-auto">
                ...
                <p>&mdash;
                    <strong class="text-black font-weight-bold">{{$testimonial->name}}</strong>, {{$testimonial->profession}}
                </p>
                <p><a href="https://vimeo.com/{{$testimonial->video_id}}" class="popup-vimeo text-uppercase">Watch Video <span
