...
Route::post('contact', 'ContactController@store')->name('create.message');
...
Route::get('/dashboard/posts', 'DashboardController@posts')->name('post.index');
Route::get('/dashboard/messages', 'DashboardController@contacts')->name('messages.index');
